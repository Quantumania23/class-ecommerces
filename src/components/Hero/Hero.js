    ...
    <section className="text-gray-600 body-font mt-20">
      <div className="container mx-auto flex px-5 py-24 md:flex-row md:justify-center flex-col items-center">
        <div className="md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Get ahold of the products now before they're sold
          </h1>
          <p className="mb-8 leading-relaxed">We have an array of items on sale ranging from women's clothes, jewelry and other accessories including imported electronics and state of the art glassware. Come one come all while stocks last</p>
